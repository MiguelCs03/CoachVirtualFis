...
class MusculoModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.musculo = Musculo.objects.create(nombre="Bíceps", url="https://example.com/biceps.png", tipo=self.tipo)
...
class EjercicioModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.ejercicio = Ejercicio.objects.create(
            nombre="Curl de bíceps", descripcion="Ejercicio para fortalecer bíceps", url="https://example.com/curl.gif"
        )
...
class DetalleMusculoModelTest(TestCase):
    ...
    def setUp(self):
        self.tipo = Tipo.objects.create(nombre="Gimnasio")
        self.musculo = Musculo.objects.create(nombre="Espalda", url="https://example.com/espalda.png", tipo=self.tipo)
        self.detalle = DetalleMusculo.objects.create(
            nombre="Dorsal ancho", url="https://example.com/dorsal.png", musculo=self.musculo
        )
...
class EjercicioAsignadoModelTest(TestCase):
    ...
    def setUp(self):
        self.tipo = Tipo.objects.create(nombre="Gimnasio")
        self.musculo = Musculo.objects.create(nombre="Brazos", url="https://example.com/brazos.png", tipo=self.tipo)
        self.detalle = DetalleMusculo.objects.create(
        ...
        self.asignado = EjercicioAsignado.objects.create(ejercicio=self.ejercicio, detalle_musculo=self.detalle)
    ...
    def test_relaciones_completas(self):
        ...
        self.assertEqual(self.asignado.detalle_musculo.musculo.tipo.nombre, "Gimnasio")
    ...
    def setUp(self):
        ...
        self.ejercicios = [
            Ejercicio.objects.create(
                nombre="Remo sentado", descripcion="Ejercicio de espalda", url="https://cloudinary.com/remo.gif"
            ),
            Ejercicio.objects.create(
                nombre="Curl de bíceps", descripcion="Ejercicio de brazos", url="https://cloudinary.com/curl.gif"
            ),
            Ejercicio.objects.create(
                nombre="Flexiones", descripcion="Ejercicio de pecho", url="https://cloudinary.com/flexiones.gif"
            ),
        ]
    ...
    def setUp(self):
        ...
        for i in range(5):
            ejercicio = Ejercicio.objects.create(
                nombre=f"Ejercicio {i}", descripcion=f"Descripción {i}", url=f"https://example.com/ejercicio{i}.gif"
            )
            EjercicioAsignado.objects.create(ejercicio=ejercicio, detalle_musculo=self.detalle)
