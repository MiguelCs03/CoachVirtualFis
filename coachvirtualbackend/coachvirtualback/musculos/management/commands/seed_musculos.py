...
from musculos.models import DetalleMusculo, Ejercicio, Musculo, Tipo
    ...
    def seed_tipos(self):
        ...
        for t in tipos_data:
            tipo, created = Tipo.objects.update_or_create(
                id=t["id"], defaults={"nombre": t["nombre"], "estado": t["estado"]}
            )
            if created:
    ...
    def seed_musculos(self):
        ...
        musculos_data = [
            # Gimnasio (tipo_id=1)
            {
                "id": 1,
                "nombre": "Espalda",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763604770/plwajctd1bmiaz7tc9ai.png",
                "tipo_id": 1,
            },
            {
                "id": 2,
                "nombre": "Pectorales",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763604900/lozehp9xse2jk0bebq74.png",
                "tipo_id": 1,
            },
            {
                "id": 3,
                "nombre": "Abdominales",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763604953/pawh9dn24zfrpchfag8g.png",
                "tipo_id": 1,
            },
            {
                "id": 4,
                "nombre": "Brazos",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763604987/sektsdmnzjrzrdb1ziyl.png",
                "tipo_id": 1,
            },
            {
                "id": 5,
                "nombre": "Piernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763605250/lko0ysnyhslnmixk4le9.png",
                "tipo_id": 1,
            },
            # Fisioterapia (tipo_id=2)
            {
                "id": 6,
                "nombre": "Rodilla",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763605419/dq0vqy6dcggcenypviqj.png",
                "tipo_id": 2,
            },
            {
                "id": 7,
    ...
    def seed_ejercicios(self):
        ...
        ejercicios_data = [
            # Gimnasio (1-18)
            {
                ...
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763608918/rmbx2k6sjjuw6puwejwk.gif",
                "estado": True,
            },
            {
                "id": 2,
                "nombre": "Remo con mancuernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763608975/mhhvbnw6vvi33d6bxcqz.gif",
                "estado": True,
            },
            {
                "id": 3,
                "nombre": "Remo sentado en polea baja",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763609058/ucq1yvu64owemhcaojih.gif",
                "estado": True,
            },
            {
                "id": 4,
                "nombre": "Remo unilateral de pie en polea",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763609107/goqpdjoplofvfijya6kx.gif",
                "estado": True,
            },
            {
                "id": 5,
                "nombre": "Flexiones",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763609718/vxovdtgeio24tphfqxgs.gif",
                "estado": True,
            },
            {
                "id": 6,
                "nombre": "Press de banca con mancuernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763609767/rqggibhnjqpt77mqmmu6.gif",
                "estado": True,
            },
            {
                "id": 7,
                "nombre": "Aperturas inclinadas con mancuernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763609864/g9dyvja3tsal4fvtyvqb.gif",
                "estado": True,
            },
            {
                "id": 8,
                "nombre": "Press inclinado con mancuernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763609903/wk6abpvgkec6vndgypto.gif",
                "estado": True,
            },
            {
                "id": 9,
                "nombre": "Aperturas en máquina Mariposa",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610163/n6s6rehxkgkiwiwxltgj.gif",
                "estado": True,
            },
            {
                "id": 10,
                "nombre": "Plancha",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610214/robowud7tp0tnsomju7n.gif",
                "estado": True,
            },
            {
                "id": 11,
                "nombre": "Elevación de piernas en el suelo",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610227/ga5myoe1c7rvnlsdjisp.gif",
                "estado": True,
            },
            {
                "id": 12,
                "nombre": "Elevación de piernas en banco",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610319/unwmijpgd0km2qarqvhq.gif",
                "estado": True,
            },
            {
                "id": 13,
                "nombre": "Curl de bíceps con mancuernas de pie",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610353/jlyeogqte2xi1hvxdwtg.gif",
                "estado": True,
            },
            {
                "id": 14,
                "nombre": "Remo inclinado con mancuernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610423/gz7onxfhrhuuechwsp5p.gif",
                "estado": True,
            },
            {
                "id": 15,
                "nombre": "Sentadilla Hack",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610458/diuthklvq2yd6tqcflz1.gif",
                "estado": True,
            },
            {
                "id": 16,
                "nombre": "Prensa de piernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610518/ptdtxoykgv3ngji3bqca.gif",
                "estado": True,
            },
            {
                "id": 17,
                "nombre": "Elevación de talones con barra",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610552/i2dwa1ihjuhbj1yyy799.gif",
                "estado": True,
            },
            {
                "id": 18,
                "nombre": "Zancadas con mancuernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763610615/u8wsrsqh0sxhb9d6no93.gif",
                "estado": True,
            },
            # Fisioterapia (19-50)
            {
                ...
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655102/blzvewcw4k3gs3uht450.gif",
                "estado": True,
            },
            {
                "id": 20,
                "nombre": "Band Pull-Apart",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655147/lbydcpft1y2vfqvvgw6u.gif",
                "estado": True,
            },
            {
                "id": 21,
                "nombre": "Crunch Inverso",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655167/prk9ycsam4vnk0h2irg0.gif",
                "estado": True,
            },
            {
                "id": 22,
                "nombre": "Curl de bíceps Sentado",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655204/sur512lswaiycgscwonz.gif",
                "estado": True,
            },
            {
                "id": 23,
                "nombre": "Elevación de brazos",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655235/z8lhbirrm8gvijaa31bw.gif",
                "estado": True,
            },
            {
                "id": 24,
                "nombre": "Elevación corta de piernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655261/ctfckucoexxsi8pjvh6h.gif",
                "estado": True,
            },
            {
                "id": 25,
                "nombre": "Elevación Corta con mancuernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655285/lbzlhsx66mmzaavmgefw.gif",
                "estado": True,
            },
            {
                "id": 26,
                "nombre": "Elevación de manos",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655314/ecbsazfh02rtkasfsmkj.gif",
                "estado": True,
            },
            {
                "id": 27,
                "nombre": "Elevacion de Piernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655361/zfd32qjxyke65e7yjt5g.gif",
                "estado": True,
            },
            {
                "id": 28,
                "nombre": "Elevación de Puntas sentado",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655402/sfefs0bjpbuv97jsqnsj.gif",
                "estado": True,
            },
            {
                "id": 29,
                "nombre": "Elevación de rodillas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655447/a4at2px52b10sao9bbok.gif",
                "estado": True,
            },
            {
                "id": 30,
                "nombre": "Elevación de talones sentado",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655485/lpeoem8bwj9nr6btvz6i.gif",
                "estado": True,
            },
            {
                "id": 31,
                "nombre": "Elevación lateral de brazos",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655501/a2umplnxxittuz8f5hov.gif",
                "estado": True,
            },
            {
                "id": 32,
                "nombre": "Espalda Recta",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655529/r6ucaqfecnyezjcrw9se.gif",
                "estado": True,
            },
            {
                "id": 33,
                "nombre": "Elevación de glúteos del suelo",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655578/taao0a2t11p75tzqhcqy.gif",
                "estado": True,
            },
            {
                "id": 34,
                "nombre": "Estiramiento yoga",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655634/ybf3qox3lfs9osmkrvr7.gif",
                "estado": True,
            },
            {
                "id": 35,
                "nombre": "Estiramiento de piernas y flexión de rodillas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655683/txr3d4mrgotcn0vigbby.gif",
                "estado": True,
            },
            {
                "id": 36,
                "nombre": "Estiramiento laterales de cintura",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655725/zwlpw6j8aykvvqofwnod.gif",
                "estado": True,
            },
            {
                "id": 37,
                "nombre": "Extensión de piernas hacia atras",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655767/lgv7c5clvtecdx6ij0n9.gif",
                "estado": True,
            },
            {
                "id": 38,
                "nombre": "Flexión corta de Pierna y Rodilla",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655824/bp3ok1uomzacph8hq6gx.gif",
                "estado": True,
            },
            {
                "id": 39,
                "nombre": "flexión corta de pierna",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655859/catsffggsbnim5qn7nie.gif",
                "estado": True,
            },
            {
                "id": 40,
                "nombre": "Flexión de espalda, pierna y abdomen",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655884/ytrgoo1wzthgeytomyjg.gif",
                "estado": True,
            },
            {
                "id": 41,
                "nombre": "Flexiones",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655924/xtzm50dfuxjnkfug8joi.gif",
                "estado": True,
            },
            {
                "id": 42,
                "nombre": "Inclinación lateral de tronco",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655946/wwlzyizbeblquj6tztpa.gif",
                "estado": True,
            },
            {
                "id": 43,
                "nombre": "Inclinación lateral de tronco con brazos abiertos",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763655973/yiqdqkc4hk3weypjafbo.gif",
                "estado": True,
            },
            {
                "id": 44,
                "nombre": "Plancha con elevación de brazo",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763656011/lfadvrx5ymovfijqvr4h.gif",
                "estado": True,
            },
            {
                "id": 45,
                "nombre": "Press de hombros con mancuernas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763656043/naqovviofjsbr6f8dcjl.gif",
                "estado": True,
            },
            {
                "id": 46,
                "nombre": "Puente de glúteos elevando espalda del suelo",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763656076/xurdhxfojz7rmqx3tylr.gif",
                "estado": True,
            },
            {
                "id": 47,
                "nombre": "Estiramiento con manos juntas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763656112/ummf5tq7rteigpugeoga.gif",
                "estado": True,
            },
            {
                "id": 48,
                "nombre": "Rotación de antebrazo con bastón",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763656150/qocgforfofowwo9rtg8i.gif",
                "estado": True,
            },
            {
                "id": 49,
                "nombre": "Rotación de tronco sentado",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763656184/ah5ecoud4o3i5gkrx5mc.gif",
                "estado": True,
            },
            {
                "id": 50,
                "nombre": "Sentadillas",
                "url": "https://res.cloudinary.com/dwerzrgya/image/upload/v1763656211/fq9hjiqfidviolcpmfmj.gif",
                "estado": True,
            },
        ]
        ...
        for e in ejercicios_data:
            ejercicio, created = Ejercicio.objects.update_or_create(
                id=e["id"], defaults={"nombre": e["nombre"], "url": e["url"], "estado": e["estado"]}
            )
            if created:
