...
class UsuarioModelTest(TestCase):
    ...
    def test_crear_superusuario(self):
        ...
        admin = User.objects.create_superuser(username="admin", email="admin@coachvirtual.com", password="adminpass123")
    ...
    def test_email_unico(self):
        ...
        with self.assertRaises(Exception):
            User.objects.create_user(username="testuser2", email="test@coachvirtual.com", password="testpass123")
...
class UsuarioPerfilTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            username="perfiluser", email="perfil@coachvirtual.com", password="testpass123"
        )
...
class UsuarioAPITest(APITestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(username="apiuser", email="api@coachvirtual.com", password="testpass123")
        self.admin = User.objects.create_superuser(
            username="admin", email="admin@coachvirtual.com", password="adminpass123"
        )
...
class UsuarioPermisoTest(TestCase):
    ...
    def setUp(self):
        self.user_normal = User.objects.create_user(username="normal", email="normal@test.com", password="pass123")
        self.user_staff = User.objects.create_user(
            username="staff", email="staff@test.com", password="pass123", is_staff=True
        )
        self.user_super = User.objects.create_superuser(username="super", email="super@test.com", password="pass123")
...
class UsuarioSuscripcionTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(
            username="suscriptor", email="suscriptor@coachvirtual.com", password="testpass123"
        )
...
class RegistroUsuarioTest(APITestCase):
    ...
    def test_registro_sin_email(self):
        ...
        url = "/api/registro/"
        data = {"username": "sinmail", "password": "TestPass123!", "password2": "TestPass123!"}
        response = self.client.post(url, data, format="json")
    ...
    def test_registro_passwords_no_coinciden(self):
        ...
        url = "/api/registro/"
        data = {"username": "testuser", "email": "test@test.com", "password": "Pass123!", "password2": "DiferentePass!"}
        response = self.client.post(url, data, format="json")
...
class CambioPasswordTest(TestCase):
    ...
    def setUp(self):
        self.user = User.objects.create_user(username="passuser", email="pass@coachvirtual.com", password="oldpass123")
...
class ValidacionDatosUsuarioTest(TestCase):
    ...
    def test_username_requerido(self):
        ...
        with self.assertRaises(Exception):
            User.objects.create_user(username="", email="test@test.com", password="pass123")

    def test_email_formato_valido(self):
        """Test: Email debe tener formato válido"""
        user = User.objects.create_user(username="emailtest", email="valid@email.com", password="pass123")
