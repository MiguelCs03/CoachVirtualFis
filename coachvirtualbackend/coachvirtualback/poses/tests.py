...
class PoseTrainingDataModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.snapshot_data = {
            ...
            "angulos": {"codo_izq": 90.0, "codo_der": 92.0, "cuerpo": 175.0},
            "etiqueta": "correcto",
        }
    ...
    def test_etiqueta_choices(self):
        ...
        pose_correcto = PoseTrainingData.objects.create(ejercicio="plancha", tipo="snapshot", etiqueta="correcto")
        self.assertEqual(pose_correcto.etiqueta, "correcto")

        pose_incorrecto = PoseTrainingData.objects.create(ejercicio="plancha", tipo="snapshot", etiqueta="incorrecto")
        self.assertEqual(pose_incorrecto.etiqueta, "incorrecto")

    def test_ordering(self):
        """Test: Los registros se ordenan por fecha descendente"""
        pose1 = PoseTrainingData.objects.create(ejercicio="ejercicio1", tipo="snapshot", etiqueta="correcto")
        pose2 = PoseTrainingData.objects.create(ejercicio="ejercicio2", tipo="snapshot", etiqueta="correcto")
    ...
    def test_json_fields(self):
        ...
        landmarks_complejos = [{"x": 0.1, "y": 0.2, "z": 0.3, "visibility": 0.95} for _ in range(33)]
        angulos_complejos = {
            "codo_izq": 90.5,
            "codo_der": 89.3,
            "rodilla_izq": 160.0,
        ...
        pose = PoseTrainingData.objects.create(
            ejercicio="test_complejo",
            tipo="snapshot",
            landmarks=landmarks_complejos,
            angulos=angulos_complejos,
            etiqueta="correcto",
        )
    ...
    def test_crear_dataset_balanceado(self):
        ...
        for i in range(10):
            PoseTrainingData.objects.create(
                ejercicio="flexion", tipo="snapshot", etiqueta="correcto" if i < 5 else "incorrecto"
            )
...
class VoiceFeedbackTest(TestCase):
    ...
    def test_mensajes_animo_existen(self):
        ...
        mensajes_animo = ["¡Muy bien! Sigue así", "¡Excelente postura!", "¡Ejercicio completado!"]
