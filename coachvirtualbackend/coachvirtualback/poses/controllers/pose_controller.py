"""Controladores para datos de entrenamiento de poses."""
...
class PoseTrainingDataDetalleVista(APIView):
    ...
    def delete(self, request: Request, pk: int) -> Response:
        ...
        pose_data = get_object_or_404(PoseTrainingData, pk=pk)
        pose_data.delete()
        return Response({"message": "Dato de entrenamiento eliminado correctamente"}, status=status.HTTP_204_NO_CONTENT)
