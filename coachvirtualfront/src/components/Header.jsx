          ...
          {isAuthenticated && category && (
            ...
            >
              <div className="flex flex-col items-start">
                <span className="text-[8px] font-black text-white/40 tracking-[0.2em] uppercase leading-none">MODO ACTIVO</span>
                <span className="text-xs font-mono text-yellow-400 tracking-wider uppercase">{categoryLabel}</span>
              </div>
          ...
          {isAuthenticated && (
            <div className="flex items-center gap-2 pl-2 border-l border-white/10">
              <div className="hidden lg:flex flex-col items-end mr-2">
                <span className="text-[8px] font-black text-white/40 tracking-[0.2em] uppercase leading-none">OPERADOR</span>
