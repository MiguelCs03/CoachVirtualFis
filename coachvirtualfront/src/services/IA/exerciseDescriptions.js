...
export const EXERCISE_DESCRIPTIONS = {
  ...
  1: {
    ...
    instrucciones:
      'Siéntate con la espalda recta, agarra las manijas y jala hacia tu pecho manteniendo los codos cerca del cuerpo. Regresa lentamente.',
  ...
  2: {
    ...
    instrucciones:
      'Apoya una mano en un banco, inclina el torso. Sube la mancuerna hacia la cadera. Baja controladamente.',
  ...
  3: {
    ...
    instrucciones:
      'Siéntate frente a la polea, pies apoyados. Jala el cable hacia el abdomen. Aprieta los omóplatos.',
  ...
  4: {
    ...
    instrucciones:
      'De pie frente a la polea, jala con un brazo hacia la cadera rotando ligeramente. Controla el regreso.',
  ...
  5: {
    ...
    instrucciones:
      'Manos al ancho de hombros. Baja el pecho hacia el suelo manteniendo el cuerpo recto. Empuja hacia arriba.',
  ...
  6: {
    ...
    instrucciones:
      'Acostado en banco, mancuernas a los lados del pecho. Empuja hacia arriba juntando las mancuernas. Baja controlado.',
  ...
  7: {
    ...
    instrucciones:
      'En banco inclinado, brazos extendidos arriba. Abre los brazos en arco hasta sentir estiramiento. Cierra.',
  ...
  8: {
    ...
    instrucciones:
      'Banco a 30-45 grados. Empuja las mancuernas desde el pecho hacia arriba. Baja controladamente.',
  ...
  9: {
    ...
    instrucciones:
      'Siéntate, brazos en las almohadillas. Junta los brazos frente a ti. Regresa controlando.',
  ...
  10: {
    ...
    instrucciones:
      'Apoya antebrazos y puntas de los pies. Mantén el cuerpo recto como una tabla. Aguanta la posición.',
  ...
  11: {
    ...
    instrucciones:
      'Acostado boca arriba, piernas juntas. Sube las piernas hasta 90 grados. Baja sin tocar el suelo.',
  ...
  12: {
    ...
    instrucciones:
      'Acostado en banco, agarra los bordes. Sube las piernas rectas. Baja controladamente.',
  ...
  13: {
    ...
    instrucciones:
      'De pie, codos pegados. Sube las mancuernas girando la palma hacia arriba. Baja lentamente.',
  ...
  14: {
    ...
    musculos: ['Dorsales', 'Romboides', 'Trapecio'],
    instrucciones:
      'Inclinado hacia adelante, mancuernas colgando. Jala hacia las caderas. Aprieta omóplatos.',
  ...
  15: {
    ...
    instrucciones:
      'Espalda contra respaldo, pies al frente. Baja doblando rodillas a 90 grados. Sube.',
  ...
  16: {
    ...
    musculos: ['Cuádriceps', 'Glúteos', 'Isquiotibiales'],
    instrucciones:
      'Pies en plataforma al ancho de hombros. Baja la plataforma doblando rodillas. Empuja sin bloquear.',
  ...
  17: {
    ...
    instrucciones:
      'Barra en hombros, puntas de pies en elevación. Sube los talones lo más alto posible. Baja lento.',
  ...
  18: {
    ...
    musculos: ['Cuádriceps', 'Glúteos', 'Isquiotibiales'],
    instrucciones:
      'Mancuernas a los lados. Da un paso largo, baja la rodilla trasera. Empuja para volver.',
  ...
  19: {
    ...
    instrucciones:
      'De pie, lleva el brazo hacia el centro del cuerpo cruzando. Mantén 3 segundos. Alterna.',
  ...
  20: {
    ...
    instrucciones:
      'Banda elástica frente a ti, brazos extendidos. Separa las manos llevando la banda al pecho. Controla el regreso.',
  ...
  21: {
    ...
    instrucciones:
      'Acostado, rodillas dobladas. Levanta las caderas del suelo contrayendo el abdomen. Baja controlado.',
  ...
  22: {
    ...
    instrucciones:
      'Sentado, codo apoyado en muslo. Sube la mancuerna lentamente. Baja controlando.',
  ...
  23: {
    ...
    instrucciones:
      'De pie, eleva los brazos lentamente hasta arriba de la cabeza. Baja controladamente.',
  ...
  25: {
    ...
    instrucciones:
      'De pie, mancuernas a los lados. Eleva hasta 45 grados lateralmente. Baja lento.',
  ...
  26: {
    ...
    instrucciones:
      'Brazos frente a ti. Abre y cierra las manos repetidamente. Mantén brazos quietos.',
  ...
  28: {
    ...
    instrucciones:
      'Sentado, pies planos. Levanta las puntas de los pies manteniendo talones en el suelo. Baja.',
  ...
  31: {
    ...
    musculos: ['Deltoides laterales', 'Trapecio'],
    instrucciones:
      'De pie, brazos a los lados. Eleva lateralmente hasta la altura de los hombros. Baja lento.',
  ...
  32: {
    ...
    instrucciones:
      'Siéntate con los pies en el suelo. Mantén la espalda completamente recta. Mantén 5 segundos.',
    erroresComunes: ['Encorvar hombros', 'Tensar cuello', 'Olvidar respirar'],
    reps: 10,
    series: 2,
    descanso: 30,
    esTiempo: true,
    tiempoMantenimiento: 5,
  },
  33: {
    ...
    instrucciones:
      'Acostado, rodillas dobladas. Aprieta glúteos y levanta la cadera. Baja lentamente.',
  ...
  34: {
    ...
    instrucciones:
      'Posición de niño o gato-vaca. Estira suavemente manteniendo la respiración profunda.',
    erroresComunes: ['Forzar posición', 'Contener respiración', 'Movimiento brusco'],
    reps: 5,
    series: 2,
    descanso: 20,
    esTiempo: true,
    tiempoMantenimiento: 20,
  },
  35: {
    ...
    instrucciones:
      'Sentado, extiende una pierna. Dobla la rodilla llevando el talón hacia ti. Alterna.',
  ...
  36: {
    ...
    instrucciones:
      'De pie, levanta un brazo e inclínate al lado opuesto. Siente el estiramiento. Mantén 15 segundos.',
    erroresComunes: ['Inclinarse adelante', 'Rotar torso', 'Forzar mucho'],
    reps: 5,
    series: 2,
    descanso: 15,
    esTiempo: true,
    tiempoMantenimiento: 15,
  },
  37: {
  ...
  38: {
    ...
    instrucciones:
      'Sentado o acostado, dobla la rodilla llevando el talón hacia el glúteo. Extiende.',
  ...
  39: {
    ...
    instrucciones:
      'De pie o sentado, dobla la rodilla llevando el pie hacia atrás. Baja controlado.',
  ...
  41: {
    ...
    instrucciones:
      'Puedes hacerlas de rodillas. Baja el pecho controladamente y empuja hacia arriba.',
  ...
  42: {
    ...
    instrucciones:
      'De pie, manos en la cadera. Inclínate lateralmente a un lado. Vuelve y alterna.',
  ...
  43: {
    ...
    instrucciones:
      'Brazos extendidos a los lados. Inclínate lateralmente manteniendo brazos en línea.',
  ...
  44: {
    ...
    instrucciones:
      'En plancha, levanta un brazo al frente manteniendo la posición estable. Alterna.',
  ...
  45: {
    ...
    instrucciones:
      'Sentado, mancuernas a la altura de los hombros. Empuja hacia arriba. Baja controlado.',
  ...
  46: {
    ...
    instrucciones:
      'Acostado, eleva caderas hasta formar línea recta. Aprieta glúteos arriba. Baja lento.',
  ...
  48: {
    ...
    instrucciones:
      'Sostén un bastón o palo. Rota el antebrazo de palma hacia arriba a palma hacia abajo.',
  ...
  49: {
    ...
    instrucciones:
      'Sentado, espalda recta. Gira el torso hacia un lado manteniendo caderas fijas. Mantén 3 segundos.',
  ...
  50: {
    ...
    instrucciones:
      'Pies al ancho de hombros. Baja como si te sentaras manteniendo espalda recta. Sube empujando talones.',
...
export function getExerciseDescription(exerciseId) {
  return (
    EXERCISE_DESCRIPTIONS[exerciseId] || {
      nombre: 'Ejercicio',
...
export function generateExerciseExplanation(exerciseId, format = 'full') {
  ...
  const getPositionInstruction = (id, nombre) => {
    ...
    // Ejercicios sentados
    if (
      nombreLower.includes('sentado') ||
      nombreLower.includes('sentada') ||
      nombreLower.includes('curl de bíceps sentado') ||
      id === 22 ||
      id === 28 ||
      id === 30 ||
      id === 49
    ...
    if (
      nombreLower.includes('elevación de piernas') ||
      nombreLower.includes('glúteos del suelo') ||
      nombreLower.includes('puente') ||
      nombreLower.includes('crunch') ||
      id === 11 ||
      id === 12 ||
      id === 21 ||
      id === 24 ||
    ...
    // Banco inclinado
    if (
      nombreLower.includes('inclinado') ||
      nombreLower.includes('inclinada') ||
      nombreLower.includes('press de banca') ||
      id === 6 ||
      id === 7 ||
      id === 8
    ) {
