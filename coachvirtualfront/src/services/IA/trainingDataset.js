...
export const PUSHUP_DATASET = {
  ...
  ejemplos: [
    ...
    },
    {
      ...
      etiqueta: 'correcto',
      landmarks: {
        shoulder: { x: 0.45, y: 0.4, z: 0 },
        elbow: { x: 0.42, y: 0.5, z: 0 },
        wrist: { x: 0.35, y: 0.55, z: 0 },
        hip: { x: 0.5, y: 0.52, z: 0 },
        knee: { x: 0.55, y: 0.65, z: 0 },
        ankle: { x: 0.6, y: 0.8, z: 0 },
      },
      angulos: {
    ...
    // ===== EJEMPLOS INCORRECTOS =====
    {
      ...
      landmarks: {
        ...
        wrist: { x: 0.35, y: 0.55, z: 0 },
        hip: { x: 0.5, y: 0.6, z: 0 }, // Cadera muy baja
    ...
    },
    {
      ...
      landmarks: {
        ...
        hip: { x: 0.5, y: 0.38, z: 0 }, // Cadera muy alta
        knee: { x: 0.55, y: 0.6, z: 0 },
        ankle: { x: 0.6, y: 0.8, z: 0 },
      },
      angulos: {
        codo: 92,
    ...
    },
    {
      ...
      landmarks: {
        shoulder: { x: 0.45, y: 0.4, z: 0 },
        elbow: { x: 0.3, y: 0.5, z: 0 }, // Codo muy separado
...
export const SQUAT_DATASET = {
  ...
  ejemplos: [
    // ===== EJEMPLOS CORRECTOS =====
    {
      ...
      etiqueta: 'correcto',
      landmarks: {
        shoulder: { x: 0.5, y: 0.25, z: 0 },
        hip: { x: 0.5, y: 0.45, z: 0 },
        knee: { x: 0.5, y: 0.65, z: 0 },
        ankle: { x: 0.5, y: 0.85, z: 0 },
      },
      angulos: {
        rodilla: 175, // De pie
        cadera: 180,
    ...
    },
    {
      ...
      etiqueta: 'correcto',
      landmarks: {
        shoulder: { x: 0.48, y: 0.3, z: 0 },
        hip: { x: 0.5, y: 0.55, z: 0 },
        knee: { x: 0.52, y: 0.7, z: 0 },
        ankle: { x: 0.5, y: 0.85, z: 0 },
      },
      angulos: {
    ...
    // ===== EJEMPLOS INCORRECTOS =====
    {
      ...
      landmarks: {
        shoulder: { x: 0.48, y: 0.3, z: 0 },
        hip: { x: 0.5, y: 0.55, z: 0 },
        knee: { x: 0.6, y: 0.7, z: 0 }, // Rodilla muy adelante
        ankle: { x: 0.5, y: 0.85, z: 0 },
      },
      angulos: {
        rodilla: 88,
        espalda: 160,
        rodilla_adelanto: 0.1, // Pasa la punta del pie
      },
  ...
  ejemplos: [
    {
      ...
      etiqueta: 'correcto',
      landmarks: {
        shoulder: { x: 0.35, y: 0.4, z: 0 },
        hip: { x: 0.5, y: 0.42, z: 0 },
    ...
    },
    {
      ...
      landmarks: {
        ...
        hip: { x: 0.5, y: 0.55, z: 0 }, // Cadera hundida
        ankle: { x: 0.75, y: 0.45, z: 0 },
      },
      angulos: {
        cuerpo: 150,
    ...
    },
    {
      ...
      landmarks: {
        ...
        hip: { x: 0.5, y: 0.3, z: 0 }, // Cadera muy alta
        ankle: { x: 0.75, y: 0.45, z: 0 },
      },
      angulos: {
        cuerpo: 200,
...
export const BICEP_CURL_DATASET = {
  ...
  ejemplos: [
    ...
    },
    {
      ...
      landmarks: {
        shoulder: { x: 0.4, y: 0.3, z: 0 },
        elbow: { x: 0.3, y: 0.5, z: 0 }, // Codo separado
  ...
  ejemplos: [
    {
      ...
      etiqueta: 'correcto',
      landmarks: {
        shoulder: { x: 0.3, y: 0.4, z: 0 },
        hip: { x: 0.5, y: 0.4, z: 0 },
        knee: { x: 0.65, y: 0.4, z: 0 },
        ankle: { x: 0.8, y: 0.4, z: 0 },
      },
      angulos: {
    ...
    },
    {
      ...
      landmarks: {
        shoulder: { x: 0.3, y: 0.4, z: 0 },
        hip: { x: 0.5, y: 0.4, z: 0 },
        knee: { x: 0.5, y: 0.25, z: 0 },
        ankle: { x: 0.5, y: 0.1, z: 0 },
      },
      angulos: {
    ...
    },
    {
      ...
      landmarks: {
        shoulder: { x: 0.3, y: 0.4, z: 0 },
        hip: { x: 0.5, y: 0.4, z: 0 },
        knee: { x: 0.55, y: 0.3, z: 0 }, // Rodilla doblada
...
export const DETECTION_THRESHOLDS = {
  ...
  curl_biceps: {
    ...
    codo_hip_dist: { max_permitido: 0.1 },
