...
export default function WizardRutinaIA() {
  ...
  const puedeAvanzar = () => {
    switch (paso) {
      ...
      case 3:
        return respuestas.diasSemana > 0
      case 4:
        return respuestas.duracion > 0
      default:
        return true
    }
  }
      ...
      <div className="min-h-screen bg-[#050505] p-6 lg:p-12 text-white font-sans">
        ...
        >
          <div className="border-l-4 border-yellow-400 pl-8">
            <p className="text-yellow-400 font-mono text-[10px] tracking-[0.4em] mb-2 uppercase flex items-center gap-2">
              <Sparkles className="w-3 h-3" /> PROTOCOLO_GENERADO_IA
            </p>
          ...
          <div className="bg-[#0f0f0f] border border-white/5 p-1 shadow-[20px_20px_0px_rgba(255,230,0,0.05)]">
            <div className="p-8 space-y-8">
              <p className="text-white/40 font-mono text-xs uppercase leading-relaxed tracking-tighter">
                {rutinaGenerada.descripcion}
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
                ...
                <ResultStat
                  label="VOLUMEN"
                  value={`${rutinaGenerada.dias.reduce((sum, d) => sum + d.ejercicios.length, 0)} UNIDADES`}
                />
              </div>
                  ...
                  <div key={idx} className="bg-white/[0.02] border border-white/5 p-6">
                    ...
                    <div className="grid gap-2">
                      {dia.ejercicios.map((ej, i) => (
                        <div
                          key={i}
                          className="flex items-center justify-between p-4 border border-white/5 bg-white/[0.01] hover:bg-white/[0.03] transition-colors"
                        >
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[8px] font-mono text-white/20 uppercase">
                              {ej.series}X{ej.repeticiones} | {ej.descanso || '60S DESCANSO'}
                            </p>
                          </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-white/5">
                <button
                  ...
                  className="flex-1 bg-yellow-400 text-black py-5 font-black uppercase tracking-[0.3em] text-[10px] hover:bg-white transition-all"
                >
                  CONFIRMAR Y CARGAR PROTOCOLO
                </button>
                <button
                  onClick={() => {
                    setPaso(1)
                  ...
                  className="px-10 py-5 border border-white/10 text-white/40 hover:text-white transition-all text-[10px] font-black tracking-widest uppercase"
                >
                  REGENERAR
                </button>
              </div>
    ...
    <div className="min-h-screen bg-[#050505] p-6 lg:p-12 text-white font-sans">
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-5xl font-black italic uppercase italic tracking-tighter">
            SISTEMA <span className="text-yellow-400">GENERATIVO</span>
          </h1>
          <p className="text-white/20 font-mono text-[9px] tracking-[0.3em] uppercase max-w-lg mx-auto leading-relaxed">
            CONFIGURE LOS PARÁMETROS OPERATIVOS PARA QUE LA UNIDAD IA SINCRONICE SU PROTOCOLO DE
            ENTRENAMIENTO.
          </p>
        </div>
        ...
        <div className="space-y-4 px-4 overflow-hidden">
          ...
          <div className="w-full bg-white/5 h-0.5 relative">
            <motion.div
              ...
              className="absolute left-0 top-0 h-full bg-yellow-400 shadow-[0_0_10px_rgba(255,230,0,0.5)]"
            />
          </div>
        </div>
            ...
            {generando ? (
              <div className="text-center py-20 space-y-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-white/20 font-mono text-[9px] tracking-widest uppercase animate-shimmer">
                    CALCULANDO_OPTIMIZACIÓN_BIOMECÁNICA...
                  </p>
                </div>
              </div>
            ) : (
                ...
                >
                    ...
                    <div className="space-y-10">
                      ...
                      <div className="py-10 space-y-8">
                        <div className="text-center">
                          <span className="text-8xl font-black italic uppercase italic tracking-tighter text-yellow-400 font-mono">
                            {respuestas.diasSemana}
                          </span>
                          <span className="text-xs font-black text-white/20 tracking-widest ml-4 uppercase">
                            SESIONES
                          </span>
                        </div>
                        <div className="relative px-10">
                          <input
                            ...
                            className="w-full h-1 bg-white/5 appearance-none cursor-crosshair accent-yellow-400"
                          />
                          <div className="flex justify-between font-mono text-[8px] text-white/20 mt-4">
                            <span>MN_03</span>
                            <span>MX_06</span>
                          </div>
                        </div>
                    ...
                    <div className="space-y-10">
                      ...
                      <div className="space-y-8">
                        <div className="space-y-4">
                          <label className="text-[9px] font-black text-white/20 tracking-widest uppercase ml-1">
                            ENFOQUE_MUSCULAR (OPCIONAL)
                          </label>
                          <div className="grid grid-cols-3 gap-2">
                            {['Piernas', 'Pecho', 'Espalda', 'Brazos', 'Abdomen', 'Hombros'].map(
                              (area) => (
                                <button
                                  key={area}
                  ...
                  <div className="flex gap-4 mt-12 pt-8 border-t border-white/5">
                    {paso > 1 && (
                      <button
                        onClick={handleBack}
                        className="px-8 py-4 border border-white/10 font-black text-[9px] text-white/40 uppercase tracking-widest hover:text-white transition-all flex items-center gap-2 shadow-sm"
                      >
...
const StepTitle = ({ num, text }) => (
  <div className="flex items-center gap-4">
    <span className="text-3xl font-black italic uppercase italic tracking-tighter text-yellow-400/20 font-mono">
      {num}
    </span>
    <h2 className="text-xl font-black italic uppercase italic tracking-tighter text-white">
      {text}
    </h2>
  </div>
)
...
const OptionCard = ({ icon: Icon, title, desc, isActive, onClick, row }) => (
  <button
    ...
    className={cx(
      ...
      isActive
        ? 'bg-yellow-400 border-yellow-400 text-black shadow-[10px_10px_0px_rgba(255,230,0,0.1)]'
  ...
  >
    <div
      className={cx(
        ...
        isActive
          ...
          : 'bg-white/5 text-white/20 border-white/5 group-hover:border-white/20'
      )}
    >
    ...
    <div>
      ...
      <div
        className={cx(
          'text-[8px] font-mono mt-1 uppercase',
...
const ResultStat = ({ label, value }) => (
  <div className="bg-white/[0.03] p-6 border border-white/5 flex flex-col items-center justify-center text-center">
    ...
    <p className="text-lg font-black italic uppercase italic tracking-tighter text-white">
      {value}
    </p>
  </div>
)
