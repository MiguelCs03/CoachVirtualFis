        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  () => [
                    {
                      ...
                      isValid: angles.leftHand >= 165 && angles.leftHand <= 195,
                    },
                    {
                      indices: [12, 14, 16],
                      angle: angles.rightHand,
                      isValid: angles.rightHand >= 165 && angles.rightHand <= 195,
                    },
                    {
                      indices: [12, 24, 26],
                      angle: angles.back,
                      isValid: angles.back >= 110 && angles.back <= 150,
                    },
                  ],
                  [angles]
                )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-xl p-6">
              ...
              <p className="text-center text-sm text-gray-500 mt-2">Postura del Triángulo</p>
            </div>
          </div>
        </div>
      </div>
