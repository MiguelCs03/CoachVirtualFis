                ...
                <tbody className="divide-y divide-gray-200">
                  {historial.map((pago) => (
                    <tr key={pago.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 sm:px-6 py-4">
                        <span
                          className={`px-2 py-1 text-xs font-semibold rounded-full ${getEstadoPagoBadge(pago.estado_pago)}`}
                        >
                          {pago.estado_pago}
                        </span>
                      </td>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {new Date(selectedPago.fecha_inicio).toLocaleString()}
                  </p>
                </div>
                <div>
                  <p className="text-gray-500">Expiración</p>
                  <p className="font-medium">
                    {new Date(selectedPago.fecha_expiracion).toLocaleString()}
                  </p>
                </div>
                <div className="col-span-2">
                  <p className="text-gray-500">Estado del Pago</p>
                  <span
                    className={`inline-block px-2 py-1 text-xs font-semibold rounded-full mt-1 ${getEstadoPagoBadge(selectedPago.estado_pago)}`}
                  >
