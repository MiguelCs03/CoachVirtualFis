  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        <button onClick={() => navigate(-1)} className="text-sm text-gray-600 mb-4">
          ← Volver
        </button>
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-2xl font-bold">
                {ejercicio.nombre || ejercicio.title || 'Ejercicio'}
              </h1>
              <p className="text-sm text-gray-500 mt-1">{ejercicio.descripcion || ''}</p>
            </div>
            <div>
              <div className="text-sm text-gray-500 text-right">
                {ejercicio.duracion || '15 min'}
              </div>
              <button
                onClick={() => alert('Iniciando sesión del ejercicio')}
          ...
          <div className="mt-6">
            ...
            <p className="text-sm text-gray-600">
              {ejercicio.instrucciones ||
                'Sigue la guía del ejercicio. Mantén postura y respiración correctas.'}
            </p>
          </div>
        </div>
      </div>
