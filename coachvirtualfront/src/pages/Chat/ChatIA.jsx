  ...
  return (
    <div className="fixed top-16 right-0 z-40">
      ...
      >
        ...
        <form
          onSubmit={handleSend}
          className="p-4 border-t border-white/10 flex gap-2 items-center bg-gray-800/90 border-b border-gray-700"
        >
          <input
            type="text"
            value={input}
          ...
          >
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M12 18v3m0 0h-3m3 0h3m-3-3a4 4 0 004-4V8a4 4 0 10-8 0v6a4 4 0 004 4z"
              />
            </svg>
