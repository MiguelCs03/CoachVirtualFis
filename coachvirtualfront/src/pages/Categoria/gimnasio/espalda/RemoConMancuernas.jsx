      ...
      <div className="min-h-screen bg-[#050505] p-6 lg:p-12 text-white font-sans">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <button onClick={handleBack} className="group flex items-center gap-3 text-white/40 hover:text-white transition-all uppercase font-black text-[10px] tracking-widest">
            <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" /> RECUPERAR_SISTEMA
          </button>
          ...
          <div className="grid lg:grid-cols-2 gap-12 bg-[#0f0f0f] border border-white/5 overflow-hidden shadow-2xl relative">
            ...
            <div className="relative h-full min-h-[400px] bg-black group">
                {passedImage ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-white/5"><Activity className="w-24 h-24" /></div>
                )}
                ...
                <div className="absolute bottom-0 w-full bg-yellow-400/10 backdrop-blur-sm border-t border-yellow-400/20 p-4 text-center">
                   <span className="text-[10px] font-black tracking-widest text-yellow-400 uppercase italic">POSTURA_CLAVE: INCLINACIÓN_45° (CADERA ~130°)</span>
                </div>
            </div>
            ...
            <div className="p-12 space-y-10 flex flex-col justify-between">
              <div className="space-y-8">
                 <div className="space-y-3">
                    ...
                    <p className="text-white/40 font-mono text-[10px] tracking-widest uppercase italic leading-relaxed">
                       El sistema verificará la inclinación constante del torso para prevenir estrés lumbar.
                    </p>
                 </div>
                 ...
                 <div className="space-y-6 pt-10 border-t border-white/5 list-none">
                    ...
                    <InstructionItem number="02" text="Incline el torso hacia adelante [hip-hinge]." />
                    <InstructionItem number="03" text="Jale mancuernas hacia la línea de la cintura." />
                 </div>
              </div>
              ...
              <button onClick={() => setStarted(true)} className="w-full bg-white text-black hover:bg-yellow-400 font-black py-6 transition-all flex items-center justify-center gap-4 uppercase text-[12px] tracking-[0.4em] group">
                DESPLEGAR_MODALIDAD_IA <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-8">
          <div className="space-y-2">
              ...
              <div className="text-[9px] font-mono tracking-widest text-white/20 uppercase pl-6">PROTOCOL: BENT-OVER_ROW_v2</div>
          </div>
          <button onClick={() => setStarted(false)} className="px-8 py-3 bg-red-500/5 border border-red-500/20 text-red-500 hover:bg-red-500 hover:text-white transition-all text-[10px] font-black uppercase tracking-widest flex items-center gap-3 group">
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-[#0f0f0f] border border-white/5 relative overflow-hidden shadow-2xl">
              ...
              <div className={cx(
                  ...
                  currentAngles.hipAngle > MAX_UPRIGHT ? 'bg-red-500 border-red-500 text-white animate-pulse' : 'bg-black/60 border-white/10 text-white'
              )}>
                  <div className="text-[9px] font-black uppercase opacity-60 tracking-[0.2em] mb-1">ÁNGULO_TORSO</div>
                  <div className="text-3xl font-black italic tracking-tighter">{currentAngles.hipAngle}°</div>
            ...
            <div className="bg-[#0f0f0f] border border-white/5 p-8 grid grid-cols-2 gap-8">
                <div className="space-y-3">
                    <div className="flex items-center gap-3 text-white/20">
                        ...
                        <span className="text-[10px] font-black tracking-widest uppercase">SIMETRÍA_DE_BRAZOS</span>
                    </div>
                    <div className={cx(
                    ...
                    <div className="h-1 w-full bg-white/5">
                        <div className="h-full bg-yellow-400" style={{ width: Math.min(100, (currentAngles.symmetryDiff / 30) * 100) + '%' }} />
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    <div className="flex items-center gap-3 text-white/20">
                        ...
                        <span className="text-[10px] font-black tracking-widest uppercase">FASE_MOVIMIENTO</span>
                    </div>
                    <div className="text-2xl font-black italic tracking-tighter text-yellow-400 uppercase">
                        {stage === 'squeezing' ? 'PEAK_HOLD' : stage}
                    </div>
                    <div className="flex gap-1">
                       {[1,2,3,4,5].map(i => <div key={i} className={cx("h-1 flex-1", i <= (stage==='pulling'?3:stage==='squeezing'?5:1) ? "bg-yellow-400" : "bg-white/5")} />)}
                    </div>
                </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-[#0f0f0f] border border-white/5 p-12 text-center relative overflow-hidden shadow-[20px_20px_0px_rgba(255,230,0,0.03)]">
                ...
                <h2 className="text-white/20 font-black text-[10px] uppercase tracking-[0.5em] mb-4">REPETICIONES_SYNC</h2>
                <div className="text-[120px] font-black text-white italic tracking-tighter leading-none">{repCount}</div>
                <button onClick={() => setRepCount(0)} className="mt-4 text-[9px] font-black text-white/20 hover:text-white transition-all uppercase tracking-widest border border-white/5 px-4 py-1">REINICIAR_CONTADOR</button>
            </div>
            ...
            <div className={cx(
                ...
                <div className="flex items-center gap-4">
                   ...
                   <p className="text-lg font-black italic uppercase italic tracking-tighter leading-tight">{feedback}</p>
                </div>
            </div>
            ...
            <div className="bg-[#111111] border border-white/5 p-8 relative space-y-8 shadow-2xl">
                ...
                <div className="relative pt-10 pb-4">
                    ...
                    <div className="relative h-6 w-full bg-white/5 overflow-hidden flex">
                        ...
                        <div className="w-[40%] h-full bg-yellow-400/20 border-x border-white/10" /> {/* Zona Ideal */}
                    ...
                    <motion.div 
                        ...
                        animate={{ left: `${Math.min(Math.max(((currentAngles.hipAngle - 80) / 100) * 100, 0), 100)}%` }}
                    >
                ...
                <div className="bg-black/40 border border-white/5 p-4 text-center">
                   <p className="text-[9px] font-mono text-white/40 uppercase leading-relaxed tracking-wider">MANTENGA EL INDICADOR EN LA ZONA CENTRAL PARA VALIDACIÓN BIOMÉTRICA.</p>
                </div>
            </div>
