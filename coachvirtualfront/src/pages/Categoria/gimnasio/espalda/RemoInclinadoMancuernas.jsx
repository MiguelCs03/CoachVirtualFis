...
export default function RemoInclinadoMancuernas() {
  ...
  const posture = (() => {
    if (currentAngles.hipAngle > MAX_UPRIGHT)
      return { text: 'MUY_PARADO', color: 'text-red-500', bg: 'bg-red-500/10' }
    if (currentAngles.hipAngle < IDEAL_HINGE_MIN)
      return { text: 'MUY_BAJO', color: 'text-yellow-400', bg: 'bg-yellow-400/10' }
            ...
            <div className="relative h-full min-h-[400px] bg-black group">
              ...
              <div className="absolute bottom-0 w-full bg-black/60 text-white p-4 text-center backdrop-blur-sm border-t border-white/10">
                <span className="text-[10px] font-black tracking-widest text-yellow-400 uppercase italic">
                  CLAVE_BIOMÉTRICA: TORSO_A_45_GRADOS
                </span>
              </div>
            </div>
            ...
            <div className="p-12 space-y-10 flex flex-col justify-between">
              <div className="space-y-8">
                ...
                <div className="space-y-6 pt-10 border-t border-white/5 list-none">
                  <InstructionItem
                    number="01"
                    text="Estabilización de cadera (Hinge) obligatoria."
                  />
                  <InstructionItem
                    number="02"
                    text="Tracción uniforme de ambos extremos musculares."
                  />
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="flex items-center justify-between border-b border-white/10 pb-8">
          <div className="space-y-2">
            ...
            <div className="text-[9px] font-mono tracking-widest text-white/20 uppercase pl-6 pl-6">
              ID_CORE: BROW_v5.2
            </div>
          </div>
          <button
            onClick={() => setStarted(false)}
            className="px-8 py-3 bg-red-500/5 border border-red-500/20 text-red-500 hover:bg-red-500 hover:text-white transition-all text-[10px] font-black uppercase tracking-widest flex items-center gap-3"
          >
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-[#0f0f0f] border border-white/5 relative overflow-hidden shadow-2xl">
              ...
              >
                ...
                <div className={cx('text-3xl font-black italic tracking-tighter', posture.color)}>
                  {currentAngles.hipAngle}°
                </div>
                <div className={cx('text-[10px] font-bold uppercase mt-1', posture.color)}>
                  {posture.text}
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#0f0f0f] border border-white/5 p-8 grid grid-cols-3 gap-8">
              ...
              <div className="space-y-3">
                ...
                <div className="text-2xl font-black italic tracking-tighter text-blue-500 italic">
                  {currentAngles.elbow}°{' '}
                  <span className="text-xs opacity-40 uppercase">MAX_95</span>
                </div>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-[#0f0f0f] border border-white/5 p-12 text-center relative overflow-hidden shadow-[20px_20px_0px_rgba(255,230,0,0.03)]">
              ...
              <h2 className="text-white/20 font-black text-[10px] uppercase tracking-[0.5em] mb-4 text-white/20">
                REPETICIONES_SISTEMA
              </h2>
              ...
              <button
                ...
                className="mt-4 p-2 border border-white/5 hover:bg-white/5 transition-all"
              >
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <p className="text-lg font-black italic uppercase italic tracking-tighter leading-tight pt-1">
                  {feedback}
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#111111] border border-white/5 p-8 relative space-y-8 shadow-2xl">
              ...
              <div className="relative pt-10 pb-4">
                ...
                <div className="relative h-6 w-full bg-white/5 overflow-hidden flex">
                  <div className="w-[30%] h-full bg-yellow-400/20 px-1 border-r border-white/10" />{' '}
                  {/* Muy bajo */}
                  <div className="w-[40%] h-full bg-green-500/10 px-1 border-r border-white/10" />{' '}
                  {/* Zona Ideal */}
                ...
                <motion.div
                  ...
                  animate={{
                    left: `${Math.min(Math.max(((currentAngles.hipAngle - 90) / 90) * 100, 0), 100)}%`,
                  }}
                >
              ...
              <p className="text-[9px] font-mono text-center text-white/40 uppercase italic tracking-widest">
                SINCRO: MANTENGA EL INDICADOR EN LA ZONA CENTRAL.
              </p>
            </div>
          </div>
        </div>
