...
export default function ExtensionPiernasAtras() {
  ...
  const handlePoseDetected = (landmarks) => {
    ...
    const torsoAngle = Math.abs(
      (Math.atan2(hip.y - shoulder.y, hip.x - shoulder.x) * 180) / Math.PI - 90
    )
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="p-8">
              ...
              <ul className="list-disc pl-5 text-slate-600 mb-8 space-y-2 text-sm">
                <li>
                  Ponte de <strong>PERFIL</strong> a la cámara.
                </li>
                <li>Mantén el torso totalmente vertical (como una estatua).</li>
                <li>
                  Lleva la pierna hacia atrás <strong>sin doblar la rodilla</strong>.
                </li>
                <li>El movimiento es corto: siente el "tope" del glúteo.</li>
              </ul>
              <button
                onClick={() => setStarted(true)}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-4 rounded-xl transition-all shadow-lg shadow-blue-200"
              >
                Comenzar Terapia
              </button>
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 bg-white p-5 rounded-2xl shadow-sm border border-slate-200">
              ...
              <div className="h-6 bg-slate-100 rounded-full overflow-hidden relative">
                ...
                {/* Indicador */}
                <div
                  className={`absolute h-full width-2 bg-blue-500 transition-all duration-200 rounded-full`}
                  style={{
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center">
              ...
              <div className="relative w-32 h-16 overflow-hidden">
                ...
                {/* Aguja */}
                <div
                  className={`absolute bottom-0 left-1/2 w-1 h-14 bg-slate-800 origin-bottom transition-transform duration-300`}
              ...
              <p
                className={`text-xs mt-2 font-mono ${metrics.isStable ? 'text-green-600' : 'text-red-500 font-bold'}`}
              >
