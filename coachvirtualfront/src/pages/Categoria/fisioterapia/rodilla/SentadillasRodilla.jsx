...
export default function SentadillasRodilla() {
  ...
  const handlePoseDetected = (landmarks) => {
    ...
    if (lHip && rHip && lKnee && rKnee) {
      ...
      if (smoothFlexion < 140) {
        // Solo chequeamos durante la flexión
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="p-8">
              ...
              <ul className="list-disc pl-5 text-slate-600 mb-8 space-y-2 text-sm">
                <li>
                  <strong>Rodillas:</strong> Deben seguir la línea de los dedos del pie (¡No
                  juntarlas!).
                </li>
                <li>
                  <strong>Profundidad:</strong> Baja hasta que los muslos estén paralelos al suelo
                  (90°).
                </li>
                <li>
                  <strong>Espalda:</strong> Mantén la curva natural, no te encorves.
                </li>
              </ul>
              <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
              ...
              <div
                className={`absolute bottom-4 right-4 px-4 py-2 rounded-xl backdrop-blur-md border shadow-sm transition-all
              ...
              >
                ...
                <div className="text-2xl font-mono font-bold">
                  {Math.abs(180 - metrics.kneeFlexion)}°
                </div>
                <div className="text-[10px]">
                  {metrics.depthReached ? '¡OBJETIVO!' : 'Baja más (90°)'}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center">
              ...
              <div className="relative w-16 h-32 bg-slate-100 rounded-full overflow-hidden border border-slate-200">
                {/* Zonas */}
                <div className="absolute bottom-0 w-full h-[20%] bg-red-200 opacity-50"></div>{' '}
                {/* Muy profundo */}
                <div className="absolute bottom-[20%] w-full h-[30%] bg-green-200 opacity-50 border-t border-b border-green-300"></div>{' '}
                {/* Zona Meta */}
                {/* Bola Indicadora */}
                <div
                  className="absolute left-1/2 -translate-x-1/2 w-12 h-12 bg-indigo-600 rounded-full shadow-lg transition-all duration-300 ease-out flex items-center justify-center text-white text-[10px] font-bold"
                  style={{
