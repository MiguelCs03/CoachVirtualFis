...
export default function FlexionCortaPiernaRodilla() {
  ...
  const handlePoseDetected = (landmarks) => {
    ...
    setMetrics((prev) => ({
      ...
      maxFlexion:
        stage === 'flexing' || stage === 'hold_max' ? Math.min(prev.maxFlexion, smoothKnee) : 180,
    }))
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div className="p-8">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-4 rounded-lg transition-all shadow-md hover:shadow-lg"
              >
                Iniciar Terapia
              </button>
            </div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
              ...
              <div className="relative h-8 bg-slate-100 rounded-full overflow-hidden">
                ...
                <div
                  className={`absolute right-0 h-full transition-all duration-500 ease-out ${getProgressColor()}`}
                  style={{
          ...
          <div className="space-y-6">
            ...
            <div
              className={`p-6 rounded-2xl border-l-4 shadow-md transition-all duration-300
                    ${
                      feedback.includes('🛑')
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="text-xs text-slate-400 italic mt-2"></div>* Recuerda: No fuerces si
                sientes dolor agudo ( 4/10).
              </div>
            </div>
          </div>
        </div>
