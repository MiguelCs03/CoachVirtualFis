          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="p-8">
              ...
              <ul className="list-disc pl-5 text-slate-600 mb-8 space-y-2 text-sm">
                ...
                <li>
                  <strong>Prioridad:</strong> Mantener el cuerpo como una tabla rígida.
                </li>
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs">
                    {metrics.isCoreStable ? '✅ TABLA' : '⚠️ ARQUEADO'}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-4 bg-white p-5 rounded-2xl shadow-sm border border-slate-200 flex items-center gap-6">
              <div className="flex-1">
                ...
                <div className="h-4 bg-slate-100 rounded-full overflow-hidden relative">
                  ...
                  <div
                    className={`absolute right-0 h-full transition-all duration-200 rounded-l-full bg-indigo-500`}
                    style={{
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center">
              ...
              <div className="relative w-full h-16 flex items-center justify-center">
                ...
                {/* Cuerpo Simulado */}
                <div
                  className={`w-24 h-1 transition-all duration-300 origin-center rounded-full
