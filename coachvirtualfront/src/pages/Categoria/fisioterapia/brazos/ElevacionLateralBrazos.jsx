...
export default function ElevacionLateralBrazos() {
  ...
  useEffect(() => {
    if (started) {
      ...
      setTimeout(() => {
        speak(
          'Vamos a hacer elevación lateral de brazos. Levanta los brazos hacia los lados hasta la altura de los hombros. Mantén los codos ligeramente doblados y no encojas los hombros. ¡Comenzamos!'
        )
      }, 1500)
    }
  }, [started, speak])
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
              ...
              <div className="relative h-24 mx-auto w-40 overflow-hidden">
                ...
                {/* Arco de progreso */}
                <div
                  className="absolute bottom-0 left-1/2 -translate-x-1/2 w-32 h-32 border-[12px] border-indigo-500 rounded-full clip-path-top"
                  style={{
