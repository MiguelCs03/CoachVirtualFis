          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="p-8">
              ...
              <ul className="list-disc pl-5 text-slate-600 mb-8 space-y-2 text-sm">
                ...
                <li>
                  Levanta ambos brazos hacia los lados hasta la altura de los hombros (Forma de T).
                </li>
                <li>
                  <strong>Crucial:</strong> Mantén el cuello largo y relajado. No encojas los
                  hombros.
                </li>
              </ul>
              <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                ...
                <div className="h-3 bg-black/30 rounded-full overflow-hidden backdrop-blur-sm border border-white/30">
                  <div
                    className={`h-full transition-all duration-200 ${metrics.shrugDetected ? 'bg-red-500' : 'bg-indigo-400'}`}
                    style={{ width: `${Math.min(100, (metrics.avgArmAngle / 90) * 100)}%` }}
                  ></div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
              <h4 className="font-bold text-slate-700 mb-3 text-sm text-center">
                Simetría de Brazos
              </h4>
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="w-32 h-1 bg-slate-200 rounded relative">
                  <div
                    className={`absolute w-4 h-4 rounded-full top-1/2 -translate-y-1/2 transition-all duration-300 shadow-sm border
                                ${metrics.symmetryDiff > 15 ? 'bg-red-500 border-red-700' : 'bg-green-500 border-green-700'}`}
                    style={{
                      left: `calc(50% + ${Math.max(-45, Math.min(45, metrics.symmetryDiff * (metrics.avgArmAngle % 2 === 0 ? 1 : -1)))}%)`,
                    }}
                  >
                    {' '}
