...
export default function EstiramientoManosJuntas() {
  ...
  const handlePoseDetected = (landmarks) => {
    ...
    const updateHistory = (sho, elb) => {
      ...
      const avgSho =
        armHistoryRef.current.reduce((a, b) => a + b.sho, 0) / armHistoryRef.current.length
      const avgElb =
        armHistoryRef.current.reduce((a, b) => a + b.elb, 0) / armHistoryRef.current.length
      ...
      <div className="min-h-screen bg-green-50 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-2xl shadow-2xl text-center max-w-md w-full border border-green-100">
          ...
          <p className="text-slate-600 mb-6">
            Has completado 30 segundos de estiramiento efectivo.
          </p>
          <button
            onClick={() => {
              setStarted(false)
            ...
            className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg font-bold shadow-lg shadow-green-200"
          >
            Volver al Menú
          </button>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="p-8">
              ...
              <ul className="list-disc pl-5 text-slate-600 mb-8 space-y-2 text-sm">
                ...
                <li>
                  Mantén la posición durante <strong>30 segundos</strong> efectivos.
                </li>
              </ul>
              <button
          ...
          <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <span className="text-lg font-bold">
                    {metrics.isEffective ? 'EFECTIVO' : 'AJUSTANDO'}
                  </span>
            ...
            <div className="mt-4 bg-white p-5 rounded-2xl shadow-sm border border-slate-200 flex justify-around">
              <div className="text-center">
                ...
                <div
                  className={`text-2xl font-mono font-bold ${metrics.armExtension >= MIN_SHOULDER_FLEXION ? 'text-green-600' : 'text-amber-500'}`}
                >
              ...
              <div className="text-center">
                ...
                <div
                  className={`text-2xl font-mono font-bold ${metrics.elbowStraightness >= MIN_ELBOW_EXTENSION ? 'text-green-600' : 'text-amber-500'}`}
                >
              ...
              <div className="relative w-32 h-32 mx-auto flex items-center justify-center">
                <svg className="absolute inset-0 w-full h-full" viewBox="0 0 100 100">
                  ...
                  <circle
                    ...
                    r="45"
                    fill="none"
                    stroke={metrics.isEffective ? '#22c55e' : '#cbd5e1'}
                    strokeWidth="8"
                    strokeDasharray="283"
