          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="p-8">
              ...
              <ul className="list-disc pl-5 text-slate-600 mb-8 space-y-2 text-sm">
                ...
                <li>
                  <strong>Regla de Oro:</strong> El codo no debe separarse de tu cuerpo.
                </li>
                <li>
                  Gira la muñeca lento: Palma arriba (lleva el bastón afuera) - Palma abajo (lleva
                  el bastón adentro).
                </li>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
              ...
              <div className="absolute bottom-4 left-4 bg-white/80 backdrop-blur px-3 py-2 rounded-lg border shadow-sm">
                ...
                <div
                  className={`text-xl font-mono font-bold ${Math.abs(metrics.elbowAngle - 90) < 15 ? 'text-green-600' : 'text-red-500'}`}
                >
                  {metrics.elbowAngle}°
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-indigo-500 text-center">
              ...
              <div className="mt-6 flex justify-center gap-2">
                <div
                  className={`px-3 py-2 rounded-lg text-xs font-bold transition-all duration-300 flex flex-col items-center
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center">
              ...
              <div className="relative w-full h-12 bg-slate-100 rounded-lg overflow-hidden border border-slate-200">
                ...
                {/* Indicador */}
                <div
                  className="absolute top-0 h-full w-1 bg-slate-800 transition-all duration-300 shadow-sm z-10"
