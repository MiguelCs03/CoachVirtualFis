          ...
          <div className="bg-white rounded-xl shadow overflow-hidden">
            ...
            <div className="p-6 space-y-3">
              ...
              <ul className="list-disc pl-5 text-gray-600 space-y-1">
                <li>
                  Mantén las piernas <strong>completamente rectas</strong>.
                </li>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 relative">
            <div
              className={`rounded-2xl overflow-hidden shadow-2xl border-4 aspect-video transition-colors duration-300 ${isKneeBent ? 'border-red-500' : 'border-slate-700'}`}
            >
          ...
          <div className="space-y-6">
            ...
            {/* Estado Visual */}
            <div
              className={`p-6 rounded-2xl border transition-colors ${phase === 'up' ? 'bg-green-900/30 border-green-500/50' : 'bg-slate-800 border-slate-700'}`}
            >
            ...
            {/* Feedback */}
            <div
              className={`p-4 rounded-xl text-center font-medium border ${isKneeBent ? 'bg-red-500/20 text-red-200 border-red-500/50' : 'bg-blue-500/20 text-blue-200 border-blue-500/50'}`}
            >
              {feedback}
            </div>
          </div>
