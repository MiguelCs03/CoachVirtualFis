          ...
          <div className="bg-white rounded-xl shadow overflow-hidden">
            ...
            <div className="p-6 space-y-3">
              ...
              <ul className="list-disc pl-5 text-gray-600 space-y-1">
                ...
                <li>
                  <strong>El reto:</strong> No dejes que la cadera del lado que levantas se caiga.
                </li>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 relative">
            <div
              className={`rounded-2xl overflow-hidden shadow-2xl border-4 aspect-video transition-colors duration-300 ${isStable ? 'border-slate-700' : 'border-red-500'}`}
            >
              ...
              {currentArm && (
                <div
                  className={`absolute top-10 px-4 py-2 bg-blue-600 text-white font-bold rounded shadow-lg ${currentArm === 'left' ? 'left-10' : 'right-10'}`}
                >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700 text-center">
              ...
              <span className="text-sm text-slate-400 uppercase tracking-wider">
                Repeticiones Estables
              </span>
            </div>

            {/* Visualizador de Nivel (Giroscopio Visual) */}
            <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700">
              <h3 className="text-slate-400 text-xs uppercase mb-4 text-center">
                Estabilidad Pélvica
              </h3>
            ...
            {/* Feedback */}
            <div
              className={`p-4 rounded-xl text-center font-medium border transition-colors ${isStable ? 'bg-blue-500/20 text-blue-200 border-blue-500/50' : 'bg-red-500/20 text-red-200 border-red-500/50'}`}
            >
              {feedback}
            </div>
          </div>
