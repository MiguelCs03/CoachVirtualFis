          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="p-8">
              ...
              <ul className="list-disc pl-5 text-slate-600 mb-8 space-y-2 text-sm">
                <li>
                  Túmbate boca arriba, manos a los lados o bajo los glúteos para soporte lumbar.
                </li>
                <li>Mantén las piernas totalmente rectas (bloquea rodillas).</li>
                <li>Sube hasta formar una "L" (90°).</li>
                <li>
                  <strong>Clave:</strong> Al bajar, no permitas que se haga un hueco en tu espalda
                  baja.
                </li>
              </ul>
              <button
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
              ...
              <div className="absolute bottom-4 right-4 bg-white/80 backdrop-blur px-3 py-2 rounded-lg border shadow-sm text-right">
                ...
                <div
                  className={`text-2xl font-mono font-bold ${metrics.hipAngle <= TARGET_ANGLE ? 'text-green-600' : 'text-indigo-600'}`}
                >
                  {metrics.hipAngle}°
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center">
              ...
              <div className="relative w-12 h-32 bg-slate-100 rounded-full overflow-hidden border border-slate-200">
                ...
                {/* Indicador de Pierna */}
                <div
                  className="absolute bottom-0 w-full bg-indigo-500 transition-all duration-200 ease-out rounded-t-full"
                  style={{
                    height: `${Math.min(100, Math.max(0, ((180 - metrics.hipAngle) / 90) * 100))}%`,
                  }}
                ></div>
              </div>
