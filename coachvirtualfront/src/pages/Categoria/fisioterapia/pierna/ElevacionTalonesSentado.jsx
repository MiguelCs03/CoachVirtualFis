          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
              ...
              <div className="absolute bottom-4 right-4 bg-white/80 backdrop-blur px-3 py-2 rounded-lg border shadow-sm text-right">
                ...
                <div
                  className={`text-2xl font-mono font-bold ${metrics.ankleAngle >= TARGET_PLANTAR ? 'text-green-600' : 'text-indigo-600'}`}
                >
                  {metrics.ankleAngle}°
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center">
              ...
              <div className="relative w-16 h-32 bg-slate-100 rounded-b-lg border-t-4 border-slate-300 flex items-end justify-center">
                {/* Talón */}
                <div
                  className="w-12 bg-indigo-500 rounded-sm transition-all duration-200 ease-out shadow-sm"
                  style={{
                    height: '12px',
