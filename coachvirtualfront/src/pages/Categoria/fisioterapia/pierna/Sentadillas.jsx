    ...
    if (stage === 'stand' || stage === 'ascending') {
      ...
      if (smoothKnee > STANDING_ANGLE) {
        if (!holdStartRef.current) {
          ...
          if (isPostureCorrect) {
            // Solo cuenta si la técnica fue buena
            setRepCount((c) => c + 1)
          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="p-8">
              ...
              <ul className="list-disc pl-5 text-slate-600 mb-8 space-y-2 text-sm">
                ...
                <li>
                  Inicia el movimiento llevando la cadera atrás, no doblando rodillas primero.
                </li>
                <li>
                  <strong>Pecho Orgulloso:</strong> Mantén el torso lo más vertical posible.
                </li>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
              ...
              <div className="absolute top-4 right-4 bg-white/80 backdrop-blur px-3 py-2 rounded-lg border shadow-sm text-right">
                ...
                <div
                  className={`text-2xl font-mono font-bold ${metrics.kneeFlexion <= DEPTH_TARGET ? 'text-green-600' : 'text-indigo-600'}`}
                >
                  {metrics.kneeFlexion}°
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center">
              ...
              <div className="relative w-full h-8 bg-slate-100 rounded-full overflow-hidden">
                ...
                {/* Indicador Dinámico */}
                <div
                  className={`absolute top-0 h-full w-2 bg-indigo-600 transition-all duration-100`}
                  style={{
