          ...
          <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-200">
            ...
            <div className="p-8">
              ...
              <ul className="list-disc pl-5 text-slate-600 mb-8 space-y-2 text-sm">
                ...
                <li>
                  <strong>No muevas las rodillas.</strong>
                </li>
              </ul>
              <button
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
              ...
              <div className="absolute bottom-4 right-4 bg-white/80 backdrop-blur px-3 py-2 rounded-lg border shadow-sm text-right">
                ...
                <div
                  className={`text-2xl font-mono font-bold ${metrics.ankleAngle <= TARGET_DORSIFLEX ? 'text-green-600' : 'text-indigo-600'}`}
                >
                  {metrics.ankleAngle}°
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center">
              ...
              <div className="relative w-32 h-32 bg-slate-50 rounded-full border border-slate-200 overflow-hidden">
                ...
                {/* Pie Dinámico (Aguja) */}
                <div
                  className="absolute bottom-2 left-10 w-20 h-2 bg-indigo-500 origin-left transition-transform duration-200"
