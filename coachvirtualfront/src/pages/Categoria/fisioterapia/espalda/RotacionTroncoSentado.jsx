          ...
          <div className="bg-white rounded-xl shadow overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <ul className="list-disc pl-5 text-gray-600 space-y-2">
                <li>
                  <strong>Caderas de cemento:</strong> Imagina que tus caderas están pegadas al
                  suelo. No deben moverse.
                </li>
                <li>
                  <strong>Giro desde el pecho:</strong> La rotación debe ocurrir en las costillas,
                  no en la espalda baja.
                </li>
                <li>
                  <strong>Brazos en cruz:</strong> Ayudan a generar inercia y mantener la postura.
                </li>
              </ul>
              <button
    ...
    <div className="min-h-screen bg-blue-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-lg shadow-sm">
          ...
          <button onClick={() => setStarted(false)} className="text-red-500 hover:underline">
            Terminar
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="relative bg-black rounded-2xl overflow-hidden shadow-xl aspect-video border-4 border-white">
              ...
              <div className="absolute bottom-4 right-4 w-32 h-32 bg-white/90 rounded-full shadow-lg border-2 border-gray-200 flex items-center justify-center">
                ...
                <span className="absolute -bottom-6 text-xs font-bold bg-white px-1 rounded">
                  Vista Superior
                </span>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg">
              <h3 className="text-gray-500 text-xs uppercase tracking-wider mb-4 text-center">
                Rango de Movimiento
              </h3>
            ...
            {/* Feedback Box */}
            <div
              className={`p-4 rounded-xl font-medium text-center transition-colors duration-300 ${
                feedback.includes('✅')
            ...
            <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-100 text-sm text-yellow-800">
              💡 <strong>Tip Pro:</strong> Exhala el aire mientras giras. La falta de aire en los
              pulmones permite que la caja torácica rote unos grados extra.
            </div>
          </div>
        </div>
      </div>
