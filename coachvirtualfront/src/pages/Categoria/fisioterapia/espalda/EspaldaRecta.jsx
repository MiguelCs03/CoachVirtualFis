            ...
            <div className="mt-4 bg-white rounded-xl shadow p-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                <div className="p-2 bg-gray-50 rounded">
                  ...
                  <div
                    className={`text-xl font-bold ${getAngleColor(currentAngles.rightHip, HIP_ANGLE_MIN, HIP_ANGLE_MAX)}`}
                  >
                ...
                <div className="p-2 bg-gray-50 rounded">
                  ...
                  <div
                    className={`text-xl font-bold ${getAngleColor(currentAngles.leftHip, HIP_ANGLE_MIN, HIP_ANGLE_MAX)}`}
                  >
