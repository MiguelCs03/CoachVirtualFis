    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <button onClick={handleBack} className="text-sm text-gray-600 mb-1">
              ← Volver
            </button>
          ...
          <div className="text-right">
            ...
            <button
              onClick={() => alert('Empezando la rutina...')}
          ...
          {ejercicios.map((ej, idx) => (
            <div key={ej.id || idx} className="bg-white rounded-xl shadow p-4">
              {ej.url ? (
                ...
                <div className="w-full h-40 bg-gradient-to-br from-blue-50 to-purple-50 rounded-md mb-3 flex items-center justify-center text-gray-300">
                  Imagen
                </div>
              )}

              <h3 className="text-lg font-semibold mb-1">
                {ej.nombre || ej.title || `Ejercicio ${ej.id || idx}`}
              </h3>
              <p className="text-sm text-gray-500 mb-3">
                {ej.descripcion || ej.porcentaje ? `Porcentaje: ${ej.porcentaje || ''}` : ''}
              </p>
              ...
              <button
                onClick={() => handleStartExercise(ej)}
