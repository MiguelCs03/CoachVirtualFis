...
export default function PoseTest() {
  ...
  const stopRecording = () => {
    ...
    setSaveMessage(
      `📹 Grabación completada: ${frames.length} frames. Ahora selecciona la etiqueta para guardar.`
    )
  }
                ...
                <>
                  ...
                  <div className="mb-4 p-4 border-2 border-purple-300 rounded-lg bg-purple-50">
                    ...
                    <div className="mb-3">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Recomendado: 10-15s para 1-2 repeticiones
                      </p>
                    </div>
                    ...
                    {isRecording && (
                      <div className="mb-3 p-3 bg-red-100 border border-red-300 rounded-lg text-center animate-pulse">
                        ...
                        <div className="text-3xl font-mono font-bold text-red-700 mt-1">
                          {recordingTimer}s
                        </div>
                    ...
                    {recordedFrames.length > 0 && !isRecording && (
                      <div className="mb-3 p-3 bg-green-100 border border-green-300 rounded-lg">
                        ...
                        <div className="text-xs text-green-700 mt-1">
                          ...
                          {(recordedFrames.length / recordingDuration).toFixed(1)} FPS
                        </div>
                      </div>
                    )}
                  ...
                  <div className="mt-4 p-3 bg-blue-50 rounded-lg text-xs text-blue-800">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                      <li>
                        <strong>Snapshot:</strong> Captura una sola pose estática
                      </li>
                      <li>
                        <strong>Secuencia:</strong> Graba todo el recorrido del ejercicio (1-2 reps)
                      </li>
                    </ul>
                    <p className="mt-2 font-semibold">
                      📊 Para entrenar ML, usa el modo Secuencia para capturar el movimiento
                      completo.
                    </p>
                  </div>
                </>
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    ...
                    <div className="ml-2 text-gray-600">
                      x: {poseData.nose.x.toFixed(3)}
                      <br />
                      y: {poseData.nose.y.toFixed(3)}
                      <br />
                  ...
                  <div>
                    ...
                    <div className="ml-2 text-gray-600">y: {poseData.leftWrist.y.toFixed(3)}</div>
                  </div>
                  <div>
                    <strong>Muñeca Der:</strong>
                    <div className="ml-2 text-gray-600">y: {poseData.rightWrist.y.toFixed(3)}</div>
                  </div>
                </div>
              ) : (
