...
} from '../../services/IA/poseDetectionConfig'
...
export default function UniversalExerciseDetector({
  ...
  return (
    <div className="relative bg-slate-900 rounded-xl overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-300 text-sm">
                {exerciseInfo.musculo} • {exerciseInfo.tipo}
              </p>
            </div>
      ...
      <div
        className={`absolute bottom-4 left-4 px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 ${
          isInPosition ? 'bg-green-500 text-white' : 'bg-yellow-500 text-black'
        }`}
      >
