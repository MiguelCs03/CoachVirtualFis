...
import DetalleMusculo from '../pages/DetalleMusculo/DetalleMusculo'
import EjercicioAsignado from '../pages/GestionarEjercicio_Asignacion/EjercicioAsignado'
    ...
    <Routes>
      ...
      <Route element={<RequireAuth />}>
        <Route element={<AuthenticatedLayout />}>
          ...
          {/* Fisioterapia - brazos */}
          <Route
            path="/categoria/fisioterapia/brazos/aduccion-hombros"
            element={<AduccionHombros />}
          />
          <Route
            path="/categoria/fisioterapia/brazos/curl-biceps-sentado"
            element={<CurlBicepsSentado />}
          />
          <Route
            path="/categoria/fisioterapia/brazos/elevacion-brazos"
            element={<ElevacionBrazos />}
          />
          <Route
            path="/categoria/fisioterapia/brazos/elevacion-lateral-brazos"
            element={<ElevacionLateralBrazos />}
          />
          <Route
            path="/categoria/fisioterapia/brazos/press-hombros-mancuernas"
            element={<PressHombrosMancuernas />}
          />
          <Route
            path="/categoria/fisioterapia/brazos/rotacion-antebrazo-baston"
            element={<RotacionAntebrazoBaston />}
          />
          <Route
            path="/categoria/fisioterapia/brazos/estiramiento-manos-juntas"
            element={<EstiramientoManosJuntas />}
          />
          <Route path="/categoria/fisioterapia/brazos/flexiones" element={<FlexionesFisio />} />
          {/* Fisioterapia - rodilla */}
          <Route
            path="/categoria/fisioterapia/rodilla/flexion-corta-pierna-rodilla"
            element={<FlexionCortaPiernaRodilla />}
          />
          <Route
            path="/categoria/fisioterapia/rodilla/flexion-corta-pierna"
            element={<FlexionCortaPierna />}
          />
          <Route
            path="/categoria/fisioterapia/rodilla/extension-piernas-atras"
            element={<ExtensionPiernasAtras />}
          />
          <Route
            path="/categoria/fisioterapia/rodilla/estiramiento-piernas-flexion-rodillas"
            element={<EstiramientoPiernasFlexionRodillas />}
          />
          <Route
            path="/categoria/fisioterapia/rodilla/sentadillas"
            element={<SentadillasRodilla />}
          />
          <Route
            path="/categoria/fisioterapia/rodilla/elevacion-rodillas"
            element={<ElevacionRodillas />}
          />
          {/* Fisioterapia - espalda */}
          <Route path="/categoria/fisioterapia/espalda/espalda-recta" element={<EspaldaRecta />} />
          <Route
            path="/categoria/fisioterapia/espalda/band-pull-apart"
            element={<BandPullApart />}
          />
          <Route
            path="/categoria/fisioterapia/espalda/estiramiento-laterales-cintura"
            element={<EstiramientoLateralesCintura />}
          />
          <Route
            path="/categoria/fisioterapia/espalda/inclinacion-lateral-tronco"
            element={<InclinacionLateralTronco />}
          />
          <Route
            path="/categoria/fisioterapia/espalda/rotacion-tronco-sentado"
            element={<RotacionTroncoSentado />}
          />
          <Route
            path="/categoria/fisioterapia/espalda/estiramiento-yoga"
            element={<EstiramientoYoga />}
          />
          <Route
            path="/categoria/fisioterapia/espalda/flexion-espalda-pierna-abdomen"
            element={<FlexionEspaldaPiernaAbdomen />}
          />
          {/* Fisioterapia - pierna */}
          <Route path="/categoria/fisioterapia/pierna/sentadillas" element={<Sentadillas />} />
          <Route
            path="/categoria/fisioterapia/pierna/elevacion-gluteos-suelo"
            element={<ElevacionGluteosSuelo />}
          />
          <Route path="/categoria/fisioterapia/pierna/puente-gluteos" element={<PuenteGluteos />} />
          <Route
            path="/categoria/fisioterapia/pierna/elevacion-corta-piernas"
            element={<ElevacionCortaPiernas />}
          />
          <Route
            path="/categoria/fisioterapia/pierna/elevacion-piernas"
            element={<ElevacionPiernas />}
          />
          <Route
            path="/categoria/fisioterapia/pierna/elevacion-puntas-sentado"
            element={<ElevacionPuntasSentado />}
          />
          <Route
            path="/categoria/fisioterapia/pierna/elevacion-talones-sentado"
            element={<ElevacionTalonesSentado />}
          />
          {/* Pectorales */}
          <Route path="/categoria/gimnasio/pectorales/flexiones" element={<Flexiones />} />
          <Route
            path="/categoria/gimnasio/pectorales/press-banca"
            element={<PressBancaPectorales />}
          />
          <Route
            path="/categoria/gimnasio/pectorales/aperturas-inclinado"
            element={<AperturasInclinadoPectorales />}
          />
          <Route
            path="/categoria/gimnasio/pectorales/press-inclinado"
            element={<PressInclinadoPectorales />}
          />
          <Route
            path="/categoria/gimnasio/pectorales/aperturas-mariposa"
            element={<AperturasMariposa />}
          />
          {/* Espalda */}
          <Route
            path="/categoria/gimnasio/espalda/remo-sentado-maquina"
            element={<RemoSentadoMaquina />}
          />
          <Route
            path="/categoria/gimnasio/espalda/remo-con-mancuernas"
            element={<RemoConMancuernas />}
          />
          <Route
            path="/categoria/gimnasio/espalda/remo-sentado-polea-baja"
            element={<RemoSentadoPoleaBaja />}
          />
          <Route
            path="/categoria/gimnasio/espalda/remo-unilateral-pie-polea"
            element={<RemoUnilateralPiePolea />}
          />
          <Route
            path="/categoria/gimnasio/espalda/remo-inclinado-mancuernas"
            element={<RemoInclinadoMancuernas />}
          />
          ...
          <Route
            path="/categoria/gimnasio/abdominales/elevacion-piernas-suelo"
            element={<ElevacionPiernasSuelo />}
          />
          <Route
            path="/categoria/gimnasio/abdominales/elevacion-piernas-banco"
            element={<ElevacionPiernasBanco />}
          />
          {/* Fisioterapia - abdominales */}
          <Route
            path="/categoria/fisioterapia/abdominales/crunch-inverso"
            element={<CrunchInverso />}
          />
          <Route
            path="/categoria/fisioterapia/abdominales/elevacion-piernas"
            element={<ElevacionPiernasAbd />}
          />
          ...
          <Route element={<RequireSuper />}>
            ...
            <Route path="/detalles-musculo" element={<DetalleMusculo />} />
            <Route path="/ejercicios-asignados" element={<EjercicioAsignado />} />
